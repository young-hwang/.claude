---
description: Tester agent that runs tests and reports results to developer
category: version-control-git
argument-hint: <issue_number>
allowed-tools: Bash(npm *), Bash(pytest *), Bash(gradle *), Bash(mvn *), Bash(cargo *), Bash(git *), Bash(jq *), Read, Glob, Grep
---
