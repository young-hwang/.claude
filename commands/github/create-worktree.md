---
description: Create a worktree for a Github issue in the parent directory
category: version-control-git
argument-hint: <github_issue_url_or_number>
allowed-tools: Bash(gh *), Bash(git *), Bash(tmux *), Read, Edit, Write
---
